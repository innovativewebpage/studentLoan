...
<body>
    ...
    <header id="header">
        <nav class="navbar navbar-inverse" role="banner">
          ...
          <ul class="nav navbar-nav">
           <li><a href="Profileview.php">User Detail </a></li>
           <li class="active"><a href="adminview.php">Loan Request </a></li>
    ...
    $qry=mysql_query("select * from personal where status='0'");
	...
	<td><a href="view_student.php?id=<?php echo $row['pid']; ?>">view</a></td>
		   </tr>
